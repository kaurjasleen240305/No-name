...
void CompareCSandThreshold_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void CompareCSandThreshold_3_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[4] = { 
Num2Bits_0_run,
LessThan_1_run,
GreaterEqThan_2_run,
CompareCSandThreshold_3_run };
...
ctx->componentMemory[coffset].templateName = "CompareCSandThreshold";
ctx->componentMemory[coffset].signalStart = soffset;
...
Fr_div(&expaux[1],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 1]); // line circom 24
Fr_gt(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 24
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_div(&expaux[0],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 1]); // line circom 24
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
Fr_div(&expaux[1],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 2]); // line circom 25
Fr_gt(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 25
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_div(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 2]); // line circom 25
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_div(&expaux[0],&signalValues[mySignalStart + 9],&signalValues[mySignalStart + 3]); // line circom 26
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
// load src
Fr_mul(&expaux[1],&circuitConstants[5],&lvar[0]); // line circom 29
Fr_div(&expaux[0],&expaux[1],&circuitConstants[6]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[1],&circuitConstants[7],&lvar[1]); // line circom 30
Fr_div(&expaux[0],&expaux[1],&circuitConstants[8]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[1],&circuitConstants[9],&signalValues[mySignalStart + 10]); // line circom 31
Fr_div(&expaux[0],&expaux[1],&circuitConstants[8]); // line circom 31
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[1],&circuitConstants[2],&signalValues[mySignalStart + 11]); // line circom 32
Fr_div(&expaux[0],&expaux[1],&circuitConstants[6]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[1],&circuitConstants[10],&lvar[3]); // line circom 33
Fr_div(&expaux[0],&expaux[1],&circuitConstants[6]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[3],&lvar[4],&lvar[5]); // line circom 34
Fr_add(&expaux[2],&expaux[3],&lvar[6]); // line circom 34
Fr_add(&expaux[1],&expaux[2],&lvar[7]); // line circom 34
Fr_add(&expaux[0],&expaux[1],&lvar[8]); // line circom 34
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_gt(&expaux[0],&signalValues[mySignalStart + 12],&circuitConstants[1]); // line circom 36
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[11];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 12],&signalValues[mySignalStart + 4]); // line circom 36
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}else{
...
// load src
Fr_sub(&expaux[1],&lvar[9],&lvar[11]); // line circom 36
Fr_mul(&expaux[0],&expaux[1],&circuitConstants[8]); // line circom 36
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_gt(&expaux[0],&lvar[10],&circuitConstants[8]); // line circom 37
if(Fr_isTrue(&expaux[0])){
{
...
CompareCSandThreshold_3_create(1,0,ctx,"main",0);
CompareCSandThreshold_3_run(0,ctx);
}
